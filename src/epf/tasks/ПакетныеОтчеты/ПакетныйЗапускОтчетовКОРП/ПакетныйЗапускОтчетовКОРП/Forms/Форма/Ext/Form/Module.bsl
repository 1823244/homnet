...
Процедура ОткрытьОтчетПрограммноИВыгрузить(Знач ИмяОтчета)
	...
	ПараметрыРежимаВыгрузки.Вставить("ВидОтчета", ИмяОтчета); // уникальный идентификатор отчета (не зависит от семейства конфигураций)
	...
	ПользовательскиеНастройки.ДополнительныеСвойства.Вставить("ПараметрыРежимаВыгрузки", ПараметрыРежимаВыгрузки);
