...
Функция ВычислитьПоказатель_стр1кол3(Знач ПериодОстатков = Неопределено)
	...
	т = СимволыОФР.Добавить(); т.Код = "55101";
	т = СимволыОФР.Добавить(); т.Код = "55102";
	т = СимволыОФР.Добавить(); т.Код = "54201";
...
Функция ВычислитьПоказатель_стр2кол3(Знач ПериодОстатков = Неопределено)
	...
	т = СимволыОФР.Добавить(); т.Код = "55103";
	т = СимволыОФР.Добавить(); т.Код = "55111";
	т = СимволыОФР.Добавить(); т.Код = "54207";
	т = СимволыОФР.Добавить(); т.Код = "54208";
...
Функция ВычислитьПоказатель_стр3кол3(Знач ПериодОстатков = Неопределено)
	...
	т = СимволыОФР.Добавить(); т.Код = "55104";
	т = СимволыОФР.Добавить(); т.Код = "55105";
	т = СимволыОФР.Добавить(); т.Код = "55106";
	т = СимволыОФР.Добавить(); т.Код = "55107";
	т = СимволыОФР.Добавить(); т.Код = "54202";
	т = СимволыОФР.Добавить(); т.Код = "54203";
	т = СимволыОФР.Добавить(); т.Код = "54204";
...
Функция ВычислитьПоказатель_стр4кол3(Знач ПериодОстатков = Неопределено)
	...
	т = СимволыОФР.Добавить(); т.Код = "55109";
	т = СимволыОФР.Добавить(); т.Код = "55110";
	т = СимволыОФР.Добавить(); т.Код = "55610";
	т = СимволыОФР.Добавить(); т.Код = "54205";
	т = СимволыОФР.Добавить(); т.Код = "54408";
...
Функция ВычислитьПоказатель_стр6кол3(Знач ПериодОстатков = Неопределено)
	...
	т = СимволыОФР.Добавить(); т.Код = "55112";
	т = СимволыОФР.Добавить(); т.Код = "55113";
